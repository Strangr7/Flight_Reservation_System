    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try (Session session = HibernateUtil.getSessionFactory().openSession()) {
            ...
            if (existingUser != null) {
                ...
                request.getRequestDispatcher("/WEB-INF/views/register.jsp").forward(request, response); // Updated to register.jsp
                return;
            }
            ...
            String sql = "INSERT INTO users (name, email, phone, password_hash, role) " // Fixed passwordHash to password_hash
            ...
            session.createNativeQuery(sql, Void.class)
                    ...
                    .setParameter("role", UserRoles.TRAVELER.name())
                    .executeUpdate();
