...
<head>
    ...
    <!-- Custom CSS -->
    <link href="<%=request.getContextPath()%>/style/searchFlights.css" rel="stylesheet">
</head>
<body>
    <div class="container">
        <div class="search-container">
            ...
            <div class="search-content">
                    ...
                    <form id="flightSearchForm" method="get" novalidate>
                        <div class="search-options">
                            <div class="option-group">
                                ...
                                <select class="form-select" id="tripType" name="tripType" aria-label="Trip Type">
                        ...
                        <div class="form-row">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="departureAirportCode" name="departureAirportCode" placeholder="City or Airport" required aria-describedby="departureError" autocomplete="off">
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="destinationAirportCode" name="destinationAirportCode" placeholder="City or Airport" required aria-describedby="destinationError" autocomplete="off">
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control flatpickr" id="departureDate" name="departureDate" required aria-label="Departure Date">
                            ...
                            <div class="col return-date">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control flatpickr" id="returnDate" name="returnDate" aria-label="Return Date">
                                    <i class="far fa-calendar-alt input-icon"></i>
                                </div>
                            </div>
                ...
                <!-- Conditional Manage Booking and Logout Buttons -->
                <div class="mt-3 d-flex justify-content-end">
                    ...
                    %>
                        <a href="<%=request.getContextPath()%>/view?page=login" class="btn btn-secondary">Login to Manage Booking</a>
                    <% } else { %>
                        <a href="<%=request.getContextPath()%>/manageBooking" class="btn btn-primary me-2">Manage Booking</a>
    ...
    <script>
        window.contextPath = '/flight-reservation-system'; // Updated to match your context path
    </script>
    <!-- Custom JS -->
