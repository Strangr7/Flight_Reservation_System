...
<body>
    ...
    <div id="flightContainer" style="display: none;">
        <div class="container">
            ...
            <div class="search-container mb-4">
                ...
                <div class="search-content">
                    <div class="search-card">
                        ...
                        <form id="flightSearchForm" action="<%=request.getContextPath()%>/SearchFlights" method="get" novalidate>
                            <div class="form-row row g-3 align-items-center">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="departureAirportCode" name="departureAirportCode"
                                            value="<%=request.getAttribute("departureAirportCode")%>" placeholder="City or Airport" required
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="destinationAirportCode" name="destinationAirportCode"
                                            value="<%=request.getAttribute("destinationAirportCode")%>" placeholder="City or Airport" required
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control flatpickr" id="departureDate" name="departureDate"
                                            value="<%=request.getAttribute("departureDate")%>" required aria-label="Departure Date">
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control flatpickr" id="returnDate" name="returnDate"
                                            value="<%=request.getAttribute("returnDate")%>" required aria-label="Return Date">
                                        <i class="far fa-calendar-alt input-icon"></i>
                                    </div>
                                </div>
            ...
            <form action="<%=request.getContextPath()%>/SearchFlights" method="get" class="sort-form mb-3">
                <input type="hidden" name="departureAirportCode" value="<%=request.getAttribute("departureAirportCode")%>">
                <input type="hidden" name="destinationAirportCode" value="<%=request.getAttribute("destinationAirportCode")%>">
                ...
                <select id="sortBy" name="sortBy" class="form-select d-inline-block w-auto" onchange="this.form.submit()">
                    <option value="best" <%="best".equals(request.getParameter("sortBy")) ? "selected" : ""%>>Best Flight</option>
                    <option value="fastest" <%="fastest".equals(request.getParameter("sortBy")) ? "selected" : ""%>>Fastest Flight</option>
                    <option value="cheapest" <%="cheapest".equals(request.getParameter("sortBy")) ? "selected" : ""%>>Cheapest Flight</option>
                </select>
            </form>
                ...
                <div class="row flex-nowrap content-with-sidebar">
                    ...
                    <aside class="col-md-3 filters-sidebar" aria-label="Flight Filters">
                        <div class="filter-card card">
                            ...
                            <div class="filter-group">
                                ...
                                <input type="range" class="form-range" id="priceRange" min="0" max="2000" value="2000">
                                <p>Max: $<span id="priceValue">2000</span></p>
                                <label for="totalDuration" class="form-label">Total Duration (hours)</label>
                                <input type="range" class="form-range" id="totalDuration" min="0" max="50" value="50">
                                <p>Max: <span id="durationValue">50</span> hours</p>
                            </div>
                            <div class="filter-group">
                                <label class="form-label">Stops</label>
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" id="nonStop" value="nonStop">
                                    <label class="form-check-label" for="nonStop">Non-stop</label>
                                </div>
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" id="oneStop" value="oneStop">
                            ...
                            <div class="filter-group">
                                ...
                                %>
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" id="airline_<%=airline.getAirlineId()%>"
                                        name="airline" value="<%=airline.getAirlineId()%>">
                                    <label class="form-check-label" for="airline_<%=airline.getAirlineId()%>">
                    ...
                    <main class="col-md-6 results-main" role="main">
                        ...
                        for (FlightResultOneWay flightResult : flightResults.getOutboundFlights()) {
                            if (flightResult.getFlight() == null) continue;
                        ...
                        <div class="flight-card card"
                            ...
                            <div class="row align-items-center">
                                <div class="col-md-2 text-center airline-logo">
                                    <img src="<%=flightResult.getFlight().getAirline() != null && flightResult.getFlight().getAirline().getLogoUrl() != null
                                ...
                                <div class="col-md-4 text-end">
                                    <p class="price mb-2">
                                        CAD <%=flightResult.getPricesAndClasses() != null && !flightResult.getPricesAndClasses().isEmpty()
                                            ? String.format("%.2f", flightResult.getPricesAndClasses().get(0).getDynamicPrice())
                                            : "0.00"%>
                                    ...
                                    <button class="view-timeline-btn btn btn-outline-primary btn-sm mt-2"
                                        onclick="showTimeline('<%=flightResult.getFlight().getFlightId()%>')"
                                        aria-controls="timelineSidebar">View Timeline</button>
                                </div>
                            </div>
                            <div class="flight-details-dropdown" id="flightDetailsDropdown<%=flightResult.getFlight().getFlightId()%>"
                                aria-hidden="true">
                                <div class="details-content">
                                    <div class="row">
                                        ...
                                        %>
                                        <div class="col-md-4 fare-option <%=isSoldOut ? "sold-out" : ""%>">
                                            <p><strong><%=pc.getClassName() != null ? pc.getClassName() : "Unknown Class"%></strong></p>
                                            <p>from CAD <%=String.format("%.2f", pc.getDynamicPrice())%></p>
                    ...
                    <!-- Timeline Sidebar -->
                    <aside class="col-md-3 timeline-sidebar" id="timelineSidebar" aria-label="Flight Timeline">
                        <div class="timeline-card card">
                            <h3 class="timeline-title">Flight Timeline</h3>
                            <div id="timelineContent">
                                <%
                                if (flightResults != null && (!flightResults.getOutboundFlights().isEmpty() || !flightResults.getReturnFlights().isEmpty())) {
                                    List<FlightResultOneWay> allFlights = flightResults.getOutboundFlights();
                                    allFlights.addAll(flightResults.getReturnFlights());
                                    for (FlightResultOneWay flight : allFlights) {
                                        if (flight.getFlight() == null) continue;
                                ...
                                %>
                                <div class="timeline-wrapper" data-flight-id="<%=flight.getFlight().getFlightId()%>" style="display: none;">
                                    <div class="timeline">
                                        <div class="timeline-item">
                                            <div class="timeline-dot"></div>
                                            <div class="timeline-content">
                                                <p class="timeline-step">
                                                    Depart: <%=flight.getFlight().getDepartureAirport() != null
                                        ...
                                        <div class="timeline-item">
                                            ...
                                            <div class="timeline-content">
                                                <p class="timeline-step">Stop: <%=stop.getStopAirport().getAirportCode()%></p>
                                                <p class="timeline-time">Arrive: <%=stopArrivalTime%> | Depart: <%=stopDepartureTime%></p>
                                                <p class="timeline-details">Layover: <%=layoverDuration%></p>
                                            </div>
                                        </div>
                                        <%
                                                }
                                        ...
                                        <div class="timeline-item">
                                            ...
                                            <div class="timeline-content">
                                                <p class="timeline-step">
                                                    Arrive: <%=flight.getFlight().getDestinationAirport() != null
                                        ...
                                        <div class="timeline-item">
                                            <div class="timeline-content">
                                                <p class="timeline-total-duration">Total Duration: <%=totalDuration%></p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="timeline-details-content" data-flight-id="<%=flight.getFlight().getFlightId()%>">
                                        <p><strong>Airline:</strong> <%=flight.getFlight().getAirline() != null
                                            ? flight.getFlight().getAirline().getAirlineName() : "Unknown"%></p>
                                        <p><strong>Flight Number:</strong> <%=flight.getFlight().getFlightNumber() != null
                                            ? flight.getFlight().getFlightNumber() : "N/A"%></p>
                                        <% if (flight.getStopCount() > 0) { %>
                                        <p><strong>Layover Details:</strong> Connects in <%=flight.getStops().stream()
                                            .map(s -> s != null && s.getStopAirport() != null ? s.getStopAirport().getAirportName() : "Unknown")
                            ...
                            <div class="timeline-details-dropdown" id="timelineDetails" aria-hidden="true">
    ...
    <script src="<%=request.getContextPath()%>/script/flightResultsOneWay.js"></script>
</body>
</html>